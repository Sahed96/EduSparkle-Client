      ...
      <div className="relative mx-auto my-20 space-y-8 bg-white p-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] md:w-[300px] lg:w-[600px]">
        ...
        <div>
          <img
            width={60}
            height={60}
            className="h-[100px] w-[280px] rounded-xl border bg-slate-100 object-cover duration-300 hover:scale-105"
          ...
          <div className="absolute -right-[20px] -top-4 ">
            <div className="relative h-full w-full">
              ...
              <div className="absolute left-7 top-8 flex flex-col text-xl font-semibold text-white">
                <span>
                  <sub className="text-base font-normal">$</sub>
                  <span className="text-2xl">{Application_Fees}</span>
                </span>
                <span className="text-base font-normal">/Only</span>
              </div>
            </div>
          </div>
        </div>
        <div className="space-y-4">
          <p className="capitalize text-2xl font-semibold text-gray-800">
            {Scholarship_Name}
          </p>
